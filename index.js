...
function hitLikes1() {
 ...
 countLikes1.textContent = totalLikes1.toString()
  let totalDisLikes1 = parseInt(countLikes1.value) - 1
...
function hitLikes2() {
  let totalDisLikes2 = parseInt(countLikes2.value) - 1
...
btnLike2.addEventListener("click",hitLikes2)
  btnLike2.addEventListener("click",hitDisLikes1)
  btnLike2.addEventListener("click",hitDisLikes2)
